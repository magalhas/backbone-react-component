(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    root.Backbone.Component = factory(React, Backbone, _);
}(window, function (React, Backbone, _) {
  'use strict';
  /**
   * @class Backbone.Component
   ...
   * @example
   ...
   var myComponent = new Backbone.Component({
     el: $('body'),
     model: model
   });
   * @example
   ...
   var MyComponent = Backbone.Component.extend({
     model: new Backbone.React.models.MyModel()
     render: function () {
       return &lt;div&gt;Hello world!&lt;/div&gt;;
     }
   });
   */
  Backbone.Component = function (options) {
    this.cid = _.uniqueId();
  ...
  /**
   * Wraps React.Component into Backbone.Component and extends to a new
   class.
   * @method extend
   * @memberof Component
   * @static
   */
  Backbone.Component.extend = function () {
    ...
    var ComponentFactory = function () {
      ...
      _.extend(component, Backbone.Component.prototype);
      Backbone.Component.apply(component, arguments);
      return component;
    };
    ComponentFactory.extend = function () {
      return Backbone.Component.extend(_.extend({}, Clazz, arguments[0]));
    };
    return ComponentFactory;
  };
  _.extend(Backbone.Component.prototype, Backbone.Events,
  /** @lends Reactor.Component.prototype */
  {
     ...
     * @param {jQuery} [$el=this.$el] The DOM element where we want to mount
     the component.
