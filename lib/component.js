...
(function (root, factory) {
  ...
  /** @lends Backbone.React.Component */
  {
    ...
    extend: function (Clazz) {
      function Factory (props, children) {
        return (new Wrapper(Component, props, children)).component;
      }
  ...
  function Wrapper (Component, props) {
    ...
    // properties.
    this.component = _.defaults(Component.apply(this, _.rest(arguments)),
    ...
    // Set element
    if (el) this.component.setElement(el);
    // Call initialize if available
    if (this.component.initialize) this.component.initialize(props);
  ...
  /** @lends Wrapper.prototype */
  {
    ...
    setProps: function (modelOrCollection, key, target) {
      ...
      if (!target && !(this.component && this.component.isMounted())) target = this.component.props;
      var props = {};
