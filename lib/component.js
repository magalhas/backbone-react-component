...
(function (root, factory) {
    ...
    componentWillReceiveProps: function (nextProps) {
      ...
      if (this.wrapper.model && model) {
        ...
        if (this.wrapper.model.attributes) {
          this.wrapper.setState(model, void 0, nextProps);
        } else {
          for (key in model) {
            this.wrapper.setState(model[key], key, nextProps);
          }
        }
      }
      if (this.wrapper.collection && collection && !(collection instanceof Array)) {
        ...
        if (this.wrapper.collection.models) {
          this.wrapper.setState(collection, void 0, nextProps);
        } else {
          for (key in collection) {
            this.wrapper.setState(collection[key], key, nextProps);
          }
        }
      }
    },
  ...
  function Wrapper (component, initialState) {
