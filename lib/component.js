...
(function (root, factory) {
  ...
  _.extend(Wrapper.prototype, Backbone.Events, {
    ...
    setModels: function (models, initialState) {
      if (typeof models !== 'undefined' && (models.attributes ||
        ...
        this.setStateBackbone(models, void 0, initialState);
    ...
    setCollections: function (collections, initialState) {
      if (typeof collections !== 'undefined' && (collections.models ||
        ...
        this.setStateBackbone(collections, void 0, initialState);
    ...
    setStateBackbone: function (modelOrCollection, key, target) {
      ...
      if (!options || !options.wasSetInState) {
