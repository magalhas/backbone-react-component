(function (root, factory) {
  ...
  /** @lends Reactor.Component.prototype */
  {
    ...
    /**
     * Sets this.props.isRequesting as false when a model/collection request ends
     (sync occurs).
    ...
    setPropsCollection: function () {
      ...
      if (!lastArg || !lastArg.xhr || !lastArg.xhr.wasHandledByComponent) {
        if (lastArg && lastArg.xhr)
          lastArg.xhr.wasHandledByComponent = true;
