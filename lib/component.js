    ...
    startModelListeners: function () {
      if (this.model)
        this
          ...
          // If supporting nested models/collections through Backbone.DcoumentModel
          .listenTo(this.model, 'change:*', this.setPropsModel)
          .listenTo(this.model, 'add:*', this.setPropsModel)
          .listenTo(this.model, 'remove:*', this.setPropsModel);
    },
    /**
