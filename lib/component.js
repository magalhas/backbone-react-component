    ...
    __startCollectionListeners__: function (collection, key) {
      ...
      if (collection instanceof Backbone.Collection)
        this
          ...
          .listenTo(collection, 'error', _.bind(this.__onError__, this, collection, key))
          .listenTo(collection, 'request', _.bind(this.__onRequest__, this, collection, key))
          .listenTo(collection, 'sync', _.bind(this.__onSync__, this, collection, key));
      else if (collection)
    ...
    __startModelListeners__: function (model, key) {
      ...
      if (model instanceof Backbone.Model)
        this
          ...
          .listenTo(model, 'error', _.bind(this.__onError__, this, model, key))
          .listenTo(model, 'request', _.bind(this.__onRequest__, this, model, key))
          .listenTo(model, 'sync', _.bind(this.__onSync__, this, model, key));
      else if (model)
        for (key in model)
